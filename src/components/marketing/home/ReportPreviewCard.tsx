 ...
 * eligibility claim, or completed plan).
 */
export function ReportPreviewCard() {
  return (
    <div className={styles.wrap}>
      <div className={styles.badgeRow}>
        <Badge>Illustrative example — not a student assessment</Badge>
      </div>
      <div className={styles.card}>
        ...
        <div className={styles.block}>
          <p className={styles.blockLabel}>What matters most</p>
        ...
        <div className={styles.block}>
          <p className={styles.blockLabel}>Directions worth exploring</p>
          <ul>
        ...
        <div className={styles.block}>
          <p className={styles.blockLabel}>A relevant possibility</p>
          <p className={styles.plain}>{REPORT_PREVIEW.opportunity}</p>
        </div>

        <div className={styles.block}>
          <p className={styles.blockLabel}>Questions for a planning conversation</p>
          <ul>
